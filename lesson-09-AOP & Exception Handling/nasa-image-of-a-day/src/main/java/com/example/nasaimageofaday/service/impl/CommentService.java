...
public class CommentService implements ICommentService {
    ...
    @Autowired
    public CommentService(ICommentRepository commentRepository,@Value("${bad.words}") String bad_words) {
    ...
    public void save(Comment comment) throws Exception {
        if(containBadWord(comment.getCommentText())){
            throw new Exception("Feed back contain a bad words");
        }
    ...
    public boolean containBadWord(String feedback){
