...
public class BookController {
    ...
    public String borrowBook(@PathVariable Long id, @RequestParam int borrowQuantity, Model model) {
        try {
            Book book = bookService.findById(id);
    ...
    public String returnBookForm(@PathVariable Long id, Model model) {
        Book book = bookService.findById(id);
