package com.example.emailconfigapp.controller;

import com.example.emailconfigapp.model.EmailSettings;
import com.example.emailconfigapp.service.IEmailService;
...
public class EmailController {
    ...
    public String editSubmit(@ModelAttribute EmailSettings email,Model model){
        ...
        List<EmailSettings> emailSettings = emailService.findAll();
